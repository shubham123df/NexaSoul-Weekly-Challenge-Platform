...
export default function Timeline() {
  ...
  return (
    <div ref={ref} className="relative">
      {/* Connecting line */}
      <div className="absolute left-6 sm:left-1/2 top-0 bottom-0 w-0.5 bg-border sm:-translate-x-1/2 hidden sm:block" />
            ...
            >
              ...
              <div className="absolute left-6 sm:left-1/2 sm:-translate-x-1/2 z-10">
                <motion.div
                  ...
                  className="w-12 h-12 rounded-full bg-surface border-2 border-primary/50 flex items-center justify-center shadow-glow"
                >
              ...
              <div className={`w-full sm:w-[calc(50%-3rem)] pl-20 sm:pl-0 ${isLeft ? 'sm:pr-12 sm:text-right' : 'sm:pl-12 sm:text-left'}`}>
                ...
                >
                  ...
                  <p className="text-text-100 text-sm leading-relaxed">{step.description}</p>
                </motion.div>
              </div>
            </motion.div>
          );
      ...
      <motion.div
        ...
        className="absolute left-6 sm:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-accent-cyan to-accent-green origin-top sm:-translate-x-1/2 hidden sm:block"
      />
    </div>
  );
}
